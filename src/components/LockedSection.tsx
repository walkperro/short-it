    ...
    <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
      ...
      <div className="relative mt-4 overflow-hidden rounded-2xl border border-white/10 bg-black/30 p-4">
        <div className="select-none text-white/60 blur-sm">
          This section is locked. Upgrade to unlock the full analysis and context. This is what the content area looks like once you’re subscribed.
          {"\n\n"}• Entry logic{"\n"}• Invalidation{"\n"}• Sizing{"\n"}• Levels{"\n"}• Macro regime notes{"\n"}• Scenarios
        </div>
        ...
        <div className="absolute bottom-4 left-4 right-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="text-sm text-white/80">
            Upgrade to unlock <span className="text-white font-semibold">{label}</span>
          </div>
          <Link
            href="/subscribe"
