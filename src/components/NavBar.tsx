  ...
  return (
    <Link
      ...
      className={[
        ...
        active ? "bg-white text-black" : "bg-white/5 text-white/80 hover:bg-white/10",
      ].join(" ")}
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
        <Link href="/" className="flex items-center gap-2">
          ...
          <div className="leading-tight">
            ...
            <div className="text-[11px] tracking-widest text-white/50">TRADE INTEL</div>
          </div>
        </Link>

        <nav className="hidden items-center gap-2 md:flex">
          <Tab href="/ideas" label="Ideas" active={active === "ideas"} locked={false} />
          <Tab href="/conviction" label="Conviction" active={active === "conviction"} locked={lockConviction} />
          <Tab href="/macro" label="Macro" active={active === "macro"} locked={lockMacro} />
        </nav>
          ...
          <div className="flex items-center gap-2 md:hidden">
            <Link
              ...
              className={[
                ...
                active === "ideas" ? "bg-white text-black" : "bg-white/5 text-white/80",
              ].join(" ")}
            >
              Ideas
            </Link>
